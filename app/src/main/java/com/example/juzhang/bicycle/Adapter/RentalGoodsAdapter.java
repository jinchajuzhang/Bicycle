...
public class RentalGoodsAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if(imgUrl==null||imgUrl.equals("")){
            ...
            ((MyViewHolder)holder).iv_carpicture.setImageUrl(com.example.juzhang.bicycle.ContentValues.ContentValues.HOST+imgUrl);
        }
        ...
        Integer hotType = rentalCarMessage.getHotType();
        if(hotType==null)return;
        switch (hotType){
            case 0://不设置
                break;
            case 1://设置为new
